...
Reference : https://www.youtube.com/watch?v=dsH2QC6O3Gg&list=PLneBjIzDLECkz7SwM-HFqZsvAZDz4hcpq&index=4
...
### **Load Balancer SG – `elb-sg`**
Inbound:
- HTTP (80) → 0.0.0.0/0

### **EC2 SG – `ec2-web-sg`**
Inbound:
- HTTP (80) → Source: `elb-sg`
- SSH (22) → Your IP only *(optional)*
